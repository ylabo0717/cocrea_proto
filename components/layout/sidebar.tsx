...
export function Sidebar() {
  ...
  return (
    <div className={cn(
      ...
      theme === 'dark' 
        ? 'bg-[#1F2937] text-[#F5F8FA]' 
        : 'bg-gradient-to-br from-[#4096B4] via-[#2D89AC] to-[#246A8C] text-white shadow-sm'
    )}>
      <div className="px-3 py-2 flex-1">
        <div className="flex items-center justify-between pl-3 mb-14">
          <Link href="/dashboard">
            <h1 className="text-2xl font-bold text-white drop-shadow-sm transition-all duration-200 hover:scale-105">Cocrea</h1>
          </Link>
          <div className="flex items-center gap-2">
            <Button
              ...
              className={cn(
                ...
                theme === 'dark' 
                  ? 'text-[#F5F8FA] hover:text-[#F5F8FA] hover:bg-[#151B26] hover:scale-110' 
                  : 'text-white hover:text-white hover:bg-white/10 backdrop-blur-sm hover:scale-110'
              )}
              ...
              <Link key={route.href} href={route.href}>
                <Button
                  ...
                  className={cn(
                    ...
                    theme === 'dark' ? 'text-[#F5F8FA]' : 'text-white',
                    {
                      [theme === 'dark' 
                        ? 'bg-[#151B26] hover:bg-[#151B26]/80 hover:scale-[1.02]' 
                        : 'bg-white/10 hover:bg-white/15 shadow-sm hover:scale-[1.02]'
                      ]: pathname === route.href,
                      [theme === 'dark'
                ...
                >
                  <route.icon className={cn(
                    ...
                    theme === 'dark' ? route.color : 'text-white/90',
      ...
      {email && (
        <div className={cn(
          ...
          theme === 'dark' 
            ? 'border-[#151B26] text-[#F5F8FA]/90' 
            : 'border-white/10 text-white/90 shadow-sm'
        )}>
