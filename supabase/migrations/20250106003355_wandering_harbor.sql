-- Schema for Cocrea application
-- Version: 1.0.0
-- Description: Database schema for managing applications, issues, knowledge, and requests
...
-- Applications table for managing software projects
...
-- Contents table for issues, knowledge, and requests
...
-- Likes table for content reactions
CREATE TABLE likes (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  content_id uuid REFERENCES contents(id) ON DELETE CASCADE,
  user_id uuid REFERENCES users(id) ON DELETE CASCADE,
